    ...
    if (
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Only Audit/Internal Control can submit archive requests.",
          },
          {
            status:
              403,
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Provide a valid financial year and half-year.",
          },
          {
            status:
              400,
    ...
    if (
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Only a Finance & Admin Authorizer can review archive requests.",
          },
          {
            status:
              403,
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Archive request ID is required.",
          },
          {
            status:
              400,
    ...
    if (
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Only an MD Office Authorizer can perform final archive approval.",
          },
          {
            status:
              403,
    ...
    if (
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Only a Finance & Admin Authorizer can review restorations.",
          },
          {
            status:
              403,
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Restoration request ID is required.",
          },
          {
            status:
              400,
    ...
    if (
      ...
      if (
        ...
        return NextResponse.json(
          {
            error:
              "Only an MD Office Authorizer can perform final restoration approval.",
          },
          {
            status:
              403,
